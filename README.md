...
> This simple web page of todo list that is built using webpack and served by a webpack dev server.

**[To do list]** is an inital design project for a simple To do list webpage.
...
- **[Project Set up with webpack]**
- **[Index.html file set as a template using the HTML Webpack Plugin.]**
- **[Array with description [string],completed [bool]and index: [number]. in index.js file]**
...
This project is [MIT](https://github.com/helina42/Library/blob/main/LICENSE.md) 
